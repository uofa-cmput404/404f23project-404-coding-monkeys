...
class AuthorUser(AbstractUser):
    ...
    username = models.CharField(max_length=100, unique=True) # https://www.reddit.com/r/django/comments/id2ch0/user_models_username_max_length/
    ...
    is_active = models.BooleanField(default=False) # is the user account active. True when approved/whitelist disabled, False when whitelist enabled.
...
class FollowRequests(models.Model):
    ...
    requester_uuid = models.CharField(max_length=100)
    requester_host = models.CharField(max_length=350, null=True)
    requester_url = models.CharField(max_length=350, null=True)

    recipient_uuid = models.CharField(max_length=100)
