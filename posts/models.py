...
class Posts(models.Model):
    ...
    uuid = models.CharField(primary_key=True, unique=True, max_length=100)
    ...
    author_url = models.CharField(max_length=350, null=True)
    ...
    comments = models.URLField(max_length=350)
...
class Likes(models.Model):
    ...
    author_uuid = models.CharField(max_length=100)
    author_host = models.CharField(max_length=100, null=True)
    author_url = models.CharField(max_length=350, null=True)
    ...
    liked_id = models.CharField(max_length=100)
    liked_object = models.URLField(max_length=350)
